...
fixed4 _Color;
float _IntensityMt, _ContrastMt, _IntensityNm, _IntensityNmDetail, _NormalmapDetailScale, _NormalmapDetailSpeed, _MicrowaveScale, _IntensityMicrowave, _MainDetailScale, _Parallax, _ParallaxScale, _SoftFactor;
float _WaterLocalUvX, _WaterLocalUvZ, _WaterLocalUvNX, _WaterLocalUvNZ;
float _MainDetailFlow, _ReverseFlow;
